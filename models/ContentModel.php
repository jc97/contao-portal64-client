 ...
 * @method static \ContentModel|null findOneByTeam($val, $opt = array())
 * @method static \ContentModel|null findOneByUpdateTeam($val, $opt = array())
 *
 ...
 * @method static \Model\Collection|\ContentModel[]|\ContentModel|null findByTeam($val, $opt = array())
 * @method static \Model\Collection|\ContentModel[]|\ContentModel|null findByUpdateTeam($val, $opt = array())
 *
 ...
 * @method static integer countByTeam($val, $opt = array())
 * @method static integer countByUpdateTeam($val, $opt = array())
 *
 * @author Julian Knorr
 */
...
{
	/**
	 * Find an element of portal64 extension by teams whose team can be update
	 *
	 * @param array $arrTeams   The teams
	 * @param array $arrOptions An optional options array
	 *
	 * @return \Model|null The model or null if there is no element
	 */
	public static function findUpdateblePortal64ElementByTeams($arrTeams, array $arrOptions = array())
	{
		$t = static::$strTable;
		
		$arrColumns = array("$t.team IN(".implode(',', array_map('intval', $arrTeams)).") AND $t.updateTeam=1 AND type IN ('team', 'teamresults', 'teamheadline', 'teamarchive')");
