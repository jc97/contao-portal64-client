...
{
	/**
	 * Find a member by first name and last name
	 *
	 * @param string $strFirstname The first name
	 * @param string $strLastname  The last name
	 * @param array  $arrOptions   An optional options array
	 *
	 * @return \Model|null The model or null if there is no member
	 */
	public static function findByFirstnameAndLastname($strFirstname, $strLastname, array $arrOptions = array())
	{
		$t = static::$strTable;
		
		$arrColumns = array("$t.firstname=? AND $t.lastname=?");
		
		return static::findBy($arrColumns, array($strFirstname, $strLastname), $arrOptions);
	}
}
